...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="admin-template/bower_components/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">

    <!-- MetisMenu CSS -->
    <link href="admin-template/bower_components/metisMenu/dist/metisMenu.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="admin-template/dist/css/sb-admin-2.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="admin-template/bower_components/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
   ...
   <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/admin') }}">SB Admin v2.0</a>
            </div>
            <!-- /.navbar-header -->
    ...
    <script src="admin-template/bower_components/metisMenu/dist/metisMenu.min.js"></script>
